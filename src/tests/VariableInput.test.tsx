...
describe('VariableInput Component', () => {
    ...
    it('renders the variable inputs and action buttons', () => {
        render(<VariableInput variable={variable} index={0} deleteFn={mockDeleteFn} saveFn={mockSaveFn} />);
    ...
    it('saves the updated variable when the Save button is clicked', () => {
        render(<VariableInput variable={variable} index={0} deleteFn={mockDeleteFn} saveFn={mockSaveFn} />);
    ...
    it('triggers deleteFn when the Delete button is clicked', () => {
        render(<VariableInput variable={variable} index={0} deleteFn={mockDeleteFn} saveFn={mockSaveFn} />);
